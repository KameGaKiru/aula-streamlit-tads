...
if 'PETROBRAS' in ticker_symbol.upper():
    # Baixando os dados da Petrobras
    ticker_symbol_petrobras = 'PETR4.SA'
    data_petrobras = yf.download(ticker_symbol_petrobras, start='2020-01-01', end='2023-06-26')

    # Exibir os dados da Petrobras
    st.sidebar.subheader('Histórico da Petrobras')
    st.sidebar.dataframe(data_petrobras)
    ...
    st.sidebar.plotly_chart(fig_petrobras)
